    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (true)
            {
                ...
                while (close)
                {
                    ...
                    "1)press 1 Book Library\n" +
                    "2)press 2 Newspaper Library\n" +
                    "3)Press 3 Exit \n");
        ...
        public static void forBook()
        {
            ...
            while (close)
            {
                ...
                "5)To get the details of all books 5\n\n"
                );
                Console.WriteLine("--------------------------");
        ...
        public static void forborrow()
        {
            ...
            while (close)
            {
                ...
                Console.WriteLine("\nOption To Select\n" +
                "1)Press 1 to Borrow book\n" +
                "2)Press 2 to Return book\n" +
                "3)Press 3 to Search book\n" +
                "4)To Close Press Library 4 \n"
                );
                Console.WriteLine("--------------------------");
